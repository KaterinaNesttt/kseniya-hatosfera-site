...
const services = [
  ...
  },
  {
    ...
    features: ["Оцінка ринкової вартості", "Професійна фотозйомка", "Розміщення на всіх платформах", "Проведення показів"],
  },
  {
    icon: Key,
    title: "Оренда житла",
  ...
  {
    icon: ClipboardList,
    title: "Іпотечне консультування",
    description: "Допомога у підборі іпотечної програми, підготовці документів та супроводі в банку.",
    features: ["Порівняння банківських програм", "Розрахунок щомісячного платежу", "Підготовка пакету документів", "Супровід до отримання схвалення"],
  },
];
